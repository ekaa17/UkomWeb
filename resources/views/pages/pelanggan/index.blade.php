                ...
                <div class="card">
                    <div class="card-body pt-3">
                        <div class="d-flex align-items-center justify-content-between m-3">
                            <h5 class="card-title">Total : {{$pelanggans->count()}} Pelanggan</h5>
                                    ...
                                    @foreach ($pelanggans as $pelanggan)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                ...
                                                <!-- Delete Button -->
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $pelanggan->id }}">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="deleteModalLabel{{ $pelanggan->id }}">Konfirmasi Hapus</h5>
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="editModal{{ $pelanggan->id }}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
